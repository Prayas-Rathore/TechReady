        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-sky-500 to-blue-600 px-6 sm:px-8 py-8 sm:py-12">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              ...
              {/* RIGHT — Company Info */}
              <div className="text-sky-100 text-sm sm:text-right space-y-1 sm:mt-5 mt-2">
                <p>  </p>
                <p><strong>Company Number:</strong> 16823684</p>
                
                <p><strong>Contact:</strong> support@mockithub.ai</p>
              </div>
