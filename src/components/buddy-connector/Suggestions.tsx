  ...
  if (allSuggestions.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-center px-4">
        ...
        <p className="text-slate-600">Try adding more interests!</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-slate-600 mt-1">{allSuggestions.length} potential connections</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        {currentSuggestions.map((suggestion) => {
          ...
          return (
            <div key={suggestion.id} className="bg-white rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="relative px-5 pb-5">
                ...
                <div className="pt-12">
                  ...
                  {suggestion.email && (
                    <p className="text-sm text-slate-500 mb-3">{suggestion.email}</p>
                  )}
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-center gap-2">
          <button
            ...
            className="px-4 py-2 rounded-lg bg-white border border-slate-200 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-50"
          >
            Previous
          </button>
