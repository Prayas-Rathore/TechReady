...
export default function CVAnalyzerPage() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      // If file was uploaded but text not extracted yet
      if (cvFile && !cvText) {
...
- Responsibilities: Build web applications..."
                  className="w-full h-80 p-4 border border-slate-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none resize-none"
                />
              </div>
            </div>
          ) : (
